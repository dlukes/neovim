...
function vim.cmp_versions(ver1, ver2, strict)
  ver1 = vim.parse_version(ver1, strict)
  ver2 = vim.parse_version(ver2, strict)
  ...
  if not strict then return 0 end
  ...
  local success, result = pcall(vim.cmp_versions, pre1, pre2)
  if success then
    return result
  end
